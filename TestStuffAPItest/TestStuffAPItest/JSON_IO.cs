...
namespace JSONIO
{
    ...
    public class JSON_IO_OBJ
    {
        [JsonProperty()]
        public IList<JSON_IO_OBJ1> objects = new List<JSON_IO_OBJ1>();
    ...
    [JsonObject(MemberSerialization = MemberSerialization.OptIn), Serializable]
    public class JSON_IO_OBJ1 : object
    {
        //[JsonProperty()]
    ...
    class JSON_IO
    {
        ...
        public bool JSON_Serialize(JSON_IO_OBJ objectClass, out string JSONData, out Exception eSerialize)
        {
            bool rc = false;
            eSerialize = null;
            JSONData = "";
        ...
        public bool JSON_DeserializeX(string json, out JSON_IO_OBJ objectClass, out Exception eDeserialize)
        {
            bool rc = false;
            objectClass = null;
            eDeserialize = null;
            try
            {
                ...
                objectClass = (JSON_IO_OBJ)JsonConvert.DeserializeObject(json, Type.GetType("JSON_IO_OBJ"));
        ...
        public bool JSON_Deserialize<T>(string json, out JSON_IO_OBJ objectClass, out Exception eDeserialize)
        {
            bool rc = false;
            objectClass = null;
            eDeserialize = null;
            try
            {
                ...
                objectClass = JsonConvert.DeserializeObject<JSON_IO_OBJ>(json);
