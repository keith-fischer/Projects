...
def SelectFavoriteApps(vncregion):
    ...
    ClickScrollVerify(vncregion,"Home_Item_UrgentCare.png:"  , "App_txt_UrgentCare_Title.png" ,WHEEL_DOWN,10,10)
...
def GoHome():
	...
	if not imgFound:       
		ClickVerify(vncregion,"Home_Unselected.png","Apps_verifyAppsPeopleTabs.png")
	enablelog="true"
##########################################
#Script END GoHome
##########################################
...
imgPath = "C:\\Automation\\Sikuli\\HomeScreen\\HomeScreenImages.sikuli"
if not imgPath in sys.path:
...
try:
    TakeScreenShot("TEST_SelectFavoriteApps.png")
    TestVoiceMail(vncregion)
except:
    Log(logpath,"**** FAILED *****")
    TakeScreenShot("FAILED_TestVoiceMail.png")
    GoHome()
#ok
try:
    TakeScreenShot("TEST_SelectFavoriteApps.png")
    ...
    Log(logpath,"**** FAILED *****")
    TakeScreenShot("FAILED_SelectFavoriteApps.png")
    GoHome()
#ok
try:
    TakeScreenShot("TEST_TestContactUs.png")
    TestContactUs(vncregion)
except:
    Log(logpath,"**** FAILED *****")
    TakeScreenShot("FAILED_TestContactUs.png")
    GoHome()
#ok
try:
    TakeScreenShot("TEST_TestFeaturedApps.png")
    TestFeaturedApps(vncregion)
except:
    Log(logpath,"**** FAILED *****")
    TakeScreenShot("FAILED_TestFeaturedApps.png")
    GoHome()
#bug: seems not scrolloing help list
try:
    TakeScreenShot("TEST_TestHelp.png")
    TestHelp(vncregion)
except:
    Log(logpath,"**** FAILED *****")
    TakeScreenShot("FAILED_TestHelp.png")
    GoHome()

try:
    TakeScreenShot("TEST_TestAddContact.png")
    TestAddContact(vncregion)
except:
    Log(logpath,"**** FAILED *****")
    TakeScreenShot("FAILED_TestAddContact.png")
    GoHome()